...
export const MIN_BODY_LENGTH =
  MESSAGE_TYPE_SIZE + CORRELATION_ID_SIZE;
...
export const FRAME_CORRELATION_OFFSET =
  LENGTH_PREFIX_SIZE + MESSAGE_TYPE_SIZE;

/** Index of payload in a full on-wire frame. */
export const FRAME_PAYLOAD_OFFSET =
  FRAME_CORRELATION_OFFSET + CORRELATION_ID_SIZE;
...
const MESSAGE_TYPE_VALUES: ReadonlySet<number> = new Set(
